// ignore_for_file: always_specify_types, strict_raw_type, public_member_api_docs, depend_on_referenced_packages
...
class MethodChannelPdfViewer extends PdfViewerPlatform {
  ...
  Future<String?> initializePdfRenderer(Uint8List documentBytes, String documentID) async {
    return _channel.invokeMethod(
        'initializePdfRenderer', <String, dynamic>{'documentBytes': documentBytes, 'documentID': documentID});
  }
