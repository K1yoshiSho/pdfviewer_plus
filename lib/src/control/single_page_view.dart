...
import 'package:workspace_core/interactive_scroll_viewer_internal.dart';
            ...
            actions: <Widget>[
              TextButton(
                ...
                child: Text(
                  ...
                  style: _pdfViewerThemeData!.paginationDialogStyle?.cancelTextStyle!.color == null
                      ? _pdfViewerThemeData!.paginationDialogStyle?.cancelTextStyle!
                          .copyWith(color: Theme.of(context).colorScheme.primary)
                      : _pdfViewerThemeData!.paginationDialogStyle?.cancelTextStyle ??
                          const TextStyle(fontFamily: 'Roboto', fontSize: 14, fontWeight: FontWeight.w500),
                ),
              ),
              TextButton(
                onPressed: () {
                ...
                child: Text(
                  ...
                  style: _pdfViewerThemeData!.paginationDialogStyle?.okTextStyle!.color == null
      ...
      child: SizedBox(
        ...
        child: TextFormField(
          style: _pdfViewerThemeData!.paginationDialogStyle?.inputFieldTextStyle ??
              TextStyle(
                  fontFamily: 'Roboto', fontSize: 16, color: Theme.of(context).colorScheme.onSurface.withOpacity(0.87)),
          ...
          decoration: InputDecoration(
            ...
            counterStyle: _pdfViewerThemeData!.paginationDialogStyle?.pageInfoTextStyle ??
                TextStyle(
                    fontFamily: 'Roboto',
                    fontSize: 12,
                    color: Theme.of(context).colorScheme.onSurface.withOpacity(0.38)),
            errorStyle: _pdfViewerThemeData!.paginationDialogStyle?.validationTextStyle ??
                TextStyle(fontFamily: 'Roboto', fontSize: 12, color: Theme.of(context).colorScheme.error),
          ),
