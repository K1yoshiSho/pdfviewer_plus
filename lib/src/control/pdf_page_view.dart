...
class PdfPageViewState extends State<PdfPageView> {
        ...
        Positioned(
          ...
          child: PdfCheckbox(
            ...
            onChanged: (bool? value) {
              onChanged(checkBoxData[i].field.name!, value ?? false, checkBoxData[i].field.name!);
            },
            fillColor: const Color.fromARGB(255, 221, 228, 255), // Custom color for the unchecked fill
            ...
            child: PopupMenuButton<String>(
              ...
              child: Row(
                ...
                children: <Widget>[
                  ...
                  Text(selectedValue ?? '',
                      style: TextStyle(
                          color: Colors.black, fontSize: (comboButtonData.bounds.height / _heightPercentage) / 1.5)),
                  Icon(
        ...
        child: InkWell(
          onTapDown: (TapDownDetails details) {
            widget.isSigned[position]
                ? _showSignatureContextMenu(details.globalPosition, position, height)
  ...
  void _showSignatureContextMenu(Offset position, int index, double height) {
    ...
    showMenu(
      ...
      position: RelativeRect.fromLTRB(
        ...
        (localPosition.dy * widget.pdfViewerController.zoomLevel) - (kPopUpMenuHeight + height),
        overlay.size.width - localPosition.dx * widget.pdfViewerController.zoomLevel,
        overlay.size.height - localPosition.dy * widget.pdfViewerController.zoomLevel,
      ),
          ...
          builder: (BuildContext context, void Function(void Function()) setState) {
            return AlertDialog(
              ...
              title: Row(
                ...
                children: <Widget>[
                  const Text('Draw your signature',
                      style: TextStyle(fontSize: 16, fontWeight: FontWeight.w500, fontFamily: 'Roboto-Medium')),
                  InkWell(
              ...
              content: SingleChildScrollView(
                child: SizedBox(
                  width: MediaQuery.of(context).size.width < 306 ? MediaQuery.of(context).size.width : 306,
                  child: Column(
                    ...
                    children: <Widget>[
                      Container(
                        ...
                        child: SfSignaturePad(strokeColor: _strokeColor, key: _signaturePadKey),
                      ),
                      ...
                      Row(
                        ...
                        children: <Widget>[
                          const Text(
                            'Pen Color',
                            style: TextStyle(fontWeight: FontWeight.w400, fontFamily: 'Roboto-Regular'),
                          ),
                          SizedBox(
                            width: 124,
                            child: Row(
              ...
              actions: <Widget>[
                TextButton(
                  ...
                  child: const Text(
                    'CLEAR',
                    style: TextStyle(fontWeight: FontWeight.w500, fontFamily: 'Roboto-Medium'),
                  ),
                ),
                ...
                TextButton(
                  ...
                  child: const Text('SAVE', style: TextStyle(fontWeight: FontWeight.w500, fontFamily: 'Roboto-Medium')),
                )
              ],
            );
          },
  ...
  Widget build(BuildContext context) {
    _heightPercentage = widget.pdfDocument!.pages[widget.pdfViewerController.pageNumber - 1].size.height /
                ...
                child: RawKeyboardListener(
                  ...
                  onKey: (RawKeyEvent event) {
                    ...
                    if ((canvasRenderBox!.getSelectionDetails().mouseSelectionEnabled ||
                      ...
                      Clipboard.setData(ClipboardData(text: canvasRenderBox!.getSelectionDetails().copiedText ?? ''));
                    }
                      ...
                      setState(() {
                        if (canvasRenderBox != null) {
                          if (widget.interactionMode == PdfInteractionMode.selection) {
                            final bool isText = canvasRenderBox!.findTextWhileHover(details.localPosition) != null;
  ...
  void _buildFormFields() {
    ...
    for (int i = 0; i < widget.textBoxData.length; i++) {
      if (widget.pageIndex == widget.textBoxData[i].pageIndex) {
        _textFormFields.addAll(_buildTextBox(textBoxFieldData: widget.textBoxData[i], index: i));
      }
    }
          ...
          _buildCheckBox(
            ...
            onChanged: (String value, bool checked, String name) {
              setState(() {
                ...
                if (checked) {
                  widget.selectedCheckBoxItems.add(SelectedCheckBoxItem(name, checked));
                } else {
                  widget.selectedCheckBoxItems
                      .removeWhere((SelectedCheckBoxItem item) => item.value == name && item.index == !checked);
                  widget.selectedCheckBoxItems.add(SelectedCheckBoxItem(name, checked));
                }
              });
            },
    ...
    for (int i = 0; i < widget.signatureData.length; i++) {
      if (widget.signatureData[i].pageIndex == widget.pageIndex) {
        _signatureFields.addAll(_buildSignatureField(signatureFieldData: widget.signatureData[i], position: i));
      }
    }
